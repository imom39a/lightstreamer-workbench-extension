...
- Deterministic multi-event Local Injection scenarios after membership, targets, clocks, cancellation, partial outcomes, and assertions receive an explicit design decision.
