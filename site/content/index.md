<section class="hero">
  <div class="hero__copy">
    ...
    <p class="lede">Inspect clients, Sessions, Subscriptions, Item Updates, snapshots, and COMMAND lifecycles. Use Local Injection to test an update in the page without a server change.</p>
    ...
    <p class="hero__note"><span>Data stays local</span><span>No account</span><span>No analytics</span><span>Open source</span></p>
  </div>
...
<section class="outcome-strip" aria-label="Product boundaries">
  ...
  <p><strong>Local test</strong><span>Compare, edit, and inject one local Item Update from the same preview. Server Evidence stays separate.</span></p>
</section>
...
<section class="section" id="capabilities">
  <header class="section__header">
    ...
    <p>Workbench runs in Chrome DevTools. Each result links to captured Evidence or to a Local Injection that you created.</p>
  </header>
  <div class="capability-grid">
    ...
    <article class="capability-card"><span>COMMAND</span><h3>Trace a key lifecycle</h3><p>Follow ADD, UPDATE, and DELETE operations in order. Inspect Fields and related diagnostics.</p></article>
...
<section class="section guide-callout" id="developer-guide">
  <div class="guide-callout__copy">
    ...
    <p>The guide shows how to start Capture, select a Scope, inspect Evidence, review Notifications, and use Local Injection.</p>
    <a class="button button--secondary" href="{{site}}docs/developer-guide/">Open the developer guide</a>
  </div>
  <ol class="guide-steps">
    ...
    <li><span>04</span><div><strong>Preview before delivery</strong><p>Confirm the target, local-only boundary, and Source-to-Draft difference, then inject on the same Draft surface. Scenarios keep their explicit Review.</p></div></li>
  </ol>
</section>
...
<section class="final-cta">
  ...
  <p>Open Workbench in Chrome DevTools. Then use the developer guide for your first inspection.</p>
