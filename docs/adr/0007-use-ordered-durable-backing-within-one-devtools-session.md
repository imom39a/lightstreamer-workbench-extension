...
production ownership, capacity, interval, stop, and cleanup behavior is defined
by ADR 0011 and the current outcome note below.
...
the interval's Committed Evidence Boundary. Capacity or journal failure stops
acceptance fail-closed and cannot be resumed by Clear or adapter switching.
