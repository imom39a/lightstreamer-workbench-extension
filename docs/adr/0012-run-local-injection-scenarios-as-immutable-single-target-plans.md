...
- Build 4 selected-update inspection and the full Build 5 diagnostics/linting experience are independent enhancements, not prerequisites for the core Scenario workflow. Only the additive diagnostic-presence assertion family depends on Build 5's normalized diagnostic observation contract.
