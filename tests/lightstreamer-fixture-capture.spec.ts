...
assert.match(mutateClientScript, /__LSEW_CLIENT_MESSAGE_RECIPE_ADAPTER__/);
assert.match(mutateClientScript, /fixture\.update-fields\.v1/);
assert.match(mutateClientScript, /LSEW_FIXTURE_FIELD_UPDATES/);
...
assert.match(dataAdapter, /publishSnapshotBasicQty/);
...
assert.match(metadataAdapter, /update-fields/);
assert.match(metadataAdapter, /publishSnapshotBasicQty/);
