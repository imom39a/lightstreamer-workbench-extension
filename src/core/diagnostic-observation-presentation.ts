...
const DIAGNOSTIC_TITLES: Readonly<Record<string, string>> = Object.freeze({
  ...
  "workbench.history.retention-advanced": "Older Evidence removed",
  "workbench.history.journal-recovered": "History storage recovered",
  "workbench.history.memory-fallback": "History using memory",
  "workbench.history.evidence-gap": "History has an Evidence gap",
  "workbench.history.pending-pressure": "History catching up",
