...
export type EvidenceQueryTelemetry = Readonly<{ postingReads: number; postingCandidates: number; evidenceCursorReads: number; payloadHydrations: number; candidateBound: number; pageBound: number; residualScan: boolean; elapsedMs: number }>;
