...
export const PAGE_CLIENT_MESSAGE_RECIPE_ADAPTER_GLOBAL =
  "__LSEW_CLIENT_MESSAGE_RECIPE_ADAPTER__" as const;
export const PAGE_CLIENT_MESSAGE_RECIPE_ADAPTER_VERSION = 1 as const;
