...
export const panelRendererName = "react";
export const rendererBuildMarker = "LSEW_PANEL_RENDERER:react";

export type ReactPanelRendererOptions = {
...
export function mountPanelRenderer(
  root: HTMLElement,
  options: ReactPanelRendererOptions = {}
): () => void {
